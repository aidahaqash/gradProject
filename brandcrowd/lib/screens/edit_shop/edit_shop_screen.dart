...
import 'package:brandcrowd/screens/edit_shop/components/body.dart';

import 'package:flutter/material.dart';

class EditShopScreen extends StatelessWidget {
  static String routeName = "/editshop";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Shop Name', style: TextStyle(color: Colors.grey)),
      ),
      body: Body(),
